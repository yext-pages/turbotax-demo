...
export const config: TemplateConfig = directoryPageUtils.makeConfig("region", "directory_address_region", directoryProfileFields);
...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps<DirectoryProfile<never>>> = (data) => {
  return directoryPageUtils.getHeadConfig(data, "directory_region", directoryHeader(data), makeTitle(data));
};

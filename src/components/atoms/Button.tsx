...
const btnStyle: Record<Priority, Record<Purpose, string>> = {
  ...
  secondary: {
    standard: 'bg-white text-blue02 border-blue02 border-2 outline-offset-4 hover:bg-blue02/10 active:bg-blue02/20',
    passive: 'bg-white text-gray01 border-gray02 border-2 outline-offset-4 hover:bg-gray02/10 active:bg-gray02/20',
    destructive: 'bg-white text-red01 border-red02 border-2 outline-offset-4 hover:bg-red02/10 active:bg-red02/20',
    special: 'bg-white text-orange01 border-orange02 border-2 outline-offset-4 hover:bg-orange02/10 active:bg-orange02/20',
  },
  tertiary: {
